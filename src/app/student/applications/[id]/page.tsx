            ...
            <CardContent className="pt-6">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div>
                  {application.status === 'draft' ? (
                    <p className="text-sm text-muted-foreground">
                      Your application is still a draft. Upload documents and submit it for review.
                    </p>
                  ) : (
                    <p className="text-sm text-muted-foreground">
                      Your application is under review. You can upload additional documents if needed.
                    </p>
                  )}
                </div>
                <div className="flex gap-2">
                  ...
                  <Link href={`/student/applications/${application.id}/documents`}>
                    <Button>
