            ...
            <div className="grid gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="excerpt_cn">Excerpt (Chinese)</Label>
                    <Textarea
                      id="excerpt_cn"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="content_cn">Content (Chinese)</Label>
                    <Textarea
                      id="content_cn"
                ...
                <CardContent>
                  <div className="border rounded-lg p-4 bg-white dark:bg-gray-900">
                    <div className="text-green-700 dark:text-green-400 text-sm mb-1">
                      {process.env.NEXT_PUBLIC_SITE_URL || 'https://example.com'}/blog/{formData.slug}
                    </div>
                    <div className="text-blue-600 dark:text-blue-400 text-xl font-medium mb-1 hover:underline">
                      {formData.seo_title || formData.title_en || 'Your Post Title'}
                    </div>
                    <div className="text-gray-600 dark:text-gray-400 text-sm">
                      {formData.seo_description || formData.excerpt_en || 'Your post description will appear here...'}
                    </div>
                  </div>
                </CardContent>
              </Card>
