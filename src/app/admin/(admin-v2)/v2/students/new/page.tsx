    ...
    <div className="max-w-5xl mx-auto p-4 md:p-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm">Add a student record. Only full name is required. Student can claim their account later using their email.</p>
        </div>
      </div>
                      ...
                      <Card key={idx} className="relative">
                        <CardContent className="pt-5">
                          <div className="absolute top-3 right-3">
                            <Button variant="ghost" size="icon" onClick={() => removeArrayItem('education_history', idx)}>
                  ...
                  <div className="space-y-4">
                    {formData.work_experience.map((work, idx) => (
                      <Card key={idx} className="relative">
                        <CardContent className="pt-5">
                          <div className="absolute top-3 right-3">
                            <Button variant="ghost" size="icon" onClick={() => removeArrayItem('work_experience', idx)}>
                              <IconTrash className="h-4 w-4 text-destructive" />
                            </Button>
                          </div>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-4">
                    {formData.family_members.map((member, idx) => (
                      <Card key={idx} className="relative">
                        <CardContent className="pt-5">
                          <div className="absolute top-3 right-3">
                            <Button variant="ghost" size="icon" onClick={() => removeArrayItem('family_members', idx)}>
                              <IconTrash className="h-4 w-4 text-destructive" />
                            </Button>
                          </div>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <TabsContent value="additional" className="space-y-4">
              ...
              <div>
                ...
                {formData.extracurricular_activities.length === 0 ? (
                  <p className="text-muted-foreground text-center py-6 border-2 border-dashed rounded-lg">No activities added yet</p>
                ) : (
                  <div className="space-y-4">
                    {formData.extracurricular_activities.map((act, idx) => (
                      <Card key={idx} className="relative">
                        <CardContent className="pt-5">
                          <div className="absolute top-3 right-3">
                            <Button variant="ghost" size="icon" onClick={() => removeArrayItem('extracurricular_activities', idx)}>
                              <IconTrash className="h-4 w-4 text-destructive" />
                            </Button>
                          </div>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                {formData.awards.length === 0 ? (
                  <p className="text-muted-foreground text-center py-6 border-2 border-dashed rounded-lg">No awards added yet</p>
                ) : (
                  <div className="space-y-4">
                    {formData.awards.map((award, idx) => (
                      <Card key={idx} className="relative">
                        <CardContent className="pt-5">
                          <div className="absolute top-3 right-3">
                            <Button variant="ghost" size="icon" onClick={() => removeArrayItem('awards', idx)}>
                              <IconTrash className="h-4 w-4 text-destructive" />
                            </Button>
                          </div>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                {formData.publications.length === 0 ? (
                  <p className="text-muted-foreground text-center py-6 border-2 border-dashed rounded-lg">No publications added yet</p>
                ) : (
                  <div className="space-y-4">
                    {formData.publications.map((pub, idx) => (
                      <Card key={idx} className="relative">
                        <CardContent className="pt-5">
                          <div className="absolute top-3 right-3">
                            <Button variant="ghost" size="icon" onClick={() => removeArrayItem('publications', idx)}>
                              <IconTrash className="h-4 w-4 text-destructive" />
                            </Button>
                          </div>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                {formData.research_experience.length === 0 ? (
                  <p className="text-muted-foreground text-center py-6 border-2 border-dashed rounded-lg">No research experience added yet</p>
                ) : (
                  <div className="space-y-4">
                    {formData.research_experience.map((res, idx) => (
                      <Card key={idx} className="relative">
                        <CardContent className="pt-5">
                          <div className="absolute top-3 right-3">
                            <Button variant="ghost" size="icon" onClick={() => removeArrayItem('research_experience', idx)}>
                              <IconTrash className="h-4 w-4 text-destructive" />
                            </Button>
                          </div>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
