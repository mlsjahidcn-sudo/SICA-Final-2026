...
function PartnerApplicationsContent() {
  ...
  useEffect(() => {
    fetchApplications();
  }, [page, search, status, university, degreeLevel, partnerFilter]);
  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Partner Applications</h2>
          <p className="text-muted-foreground">
            Applications from partner-referred students
          </p>
        </div>
        <Button asChild>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            A list of all applications from partner-referred students
          </CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
                  ...
                  <TableRow key={app.id}>
                    ...
                    <TableCell>
                      <Badge variant="outline" className="gap-1">
                        {app.student?.referred_by_partner?.company_name || app.student?.referred_by_partner?.full_name || 'Unknown'}
                      </Badge>
                    </TableCell>
  ...
  return (
    <TooltipProvider>
      ...
      >
        ...
        <SidebarInset>
          <SiteHeader title="Partner Applications" />
          <Suspense fallback={
