...
function ApplicationDetailContent() {
  ...
  const isFinal = ['accepted', 'rejected'].includes(application.status);
    ...
    <div className="flex flex-col gap-6 p-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Badge
            variant={isFinal ? (application.status === 'accepted' ? 'default' : 'destructive') : 'secondary'}
          ...
          {!isFinal && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>This application is pending your review.</CardDescription>
              </CardHeader>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          You are accepting <strong>{application.student?.full_name}</strong>&apos;s application for{' '}
                          <strong>{application.program?.name}</strong>. This action marks the application as accepted.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                        <AlertDialogCancel disabled={actioning}>Cancel</AlertDialogCancel>
                        <AlertDialogAction onClick={(e) => { e.preventDefault(); handleApprove(); }} disabled={actioning}>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm opacity-80">
                  {application.status === 'accepted'
                    ? 'This application has been approved and the student should be notified.'
